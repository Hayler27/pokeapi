...
class DetailPokemon extends LitElement {
  ...
  _getVariant(name) {
    switch (name) {
      ...
      case 'attack': return 'warning';
      case 'defense': return '';
      case 'special-attack': return 'error';
  ...
  get buldingDetailStructure() {
    ...
    return html`
      <div data-grid="region">
        <div data-grid="zone">
          <div class="container">
            <bbva-core-image alt="Ascender logo" src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${this.pokemonDetail.id}.png"></bbva-core-image>
            <bbva-web-card-product
              heading="${this.pokemonDetail.name.toUpperCase()}" subheading="Type: ${this.pokemonDetail.types[0].type.name}"
              ...
              ${this.pokemonDetail.stats.map (
                  (statItem) => html`
                    <bbva-web-list-item-bullet slot="option"> ${statItem.stat.name.toUpperCase()}
              ...
              <bbva-web-badge-category slot="category" icon="bbva:bullet" text="Height: ${this.pokemonDetail.height} cm">
              </bbva-web-badge-category>
              <bbva-web-badge-category slot="category" icon="bbva:bullet" text="Weigth: ${this.pokemonDetail.weight} g">
              </bbva-web-badge-category>
            </bbva-web-card-product>
          </div>
        </div>
