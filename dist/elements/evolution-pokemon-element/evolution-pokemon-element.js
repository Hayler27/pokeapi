      ...
      <div data-grid="zone">
        <div class="container">
          ${this.pokemonEvolution.map(EvoItem => html`
            <bbva-web-card-product image="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${EvoItem.id}.png"
              heading="${EvoItem.name}"
              subheading="Type: ${EvoItem?.types[0]?.type.name}" categories-list-label="Categories List"
              ...
              <bbva-web-badge-category slot="category" icon="bbva:bullet" text="Height:${EvoItem.height} cm">
              </bbva-web-badge-category>
              <bbva-web-badge-category slot="category" icon="bbva:bullet" text="Weigth: ${EvoItem.weight} g">
              </bbva-web-badge-category>
