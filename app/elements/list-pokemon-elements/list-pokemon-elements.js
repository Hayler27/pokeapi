...
class ListPokemon extends LitElement {
  ...
  constructor() {
    super();
    this.dataPokeInfo = [{ name: 'poke1', hight: '20' }, { name: 'poke2', hight: '30' }, { name: 'poke3', hight: '40' }, { name: 'poke4', hight: '50' }];
    this.page = 0;
  }
  ...
  get dataTemplate() {
      ...
      <div data-grid="zone">
        <div class="container">
          ...
          <bbva-web-card-product
            ...
            @click="${() => this._goToPokeDetail(pokeItem)}" heading="${pokeItem.name}">
          </bbva-web-card-product>
        </div>`
          )}
      </div>
    ...
    <bbva-web-navigation-pagination current-page="1" id="pagination" pages="24" results="460" visible-pages="10"
